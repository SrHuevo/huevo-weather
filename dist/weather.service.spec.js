...
var current_weather_mock_1 = require("./dto/current-weather.mock");
describe("weather service", function () {
    var weatherService = new weather_service_1.WeatherService();
    test("get current weather by city name and country code", function () { return __awaiter(_this, void 0, void 0, function () {
        var city, countryCode, scope, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    city = 'london';
                    countryCode = 'ES';
                    scope = nock_1.default(environment_1.default.openweathermap.url)
                ...
                case 1:
                    response = _a.sent();
                    expect(response.data).toEqual(current_weather_mock_1.CURRENT_WEATHER_MOCK);
                    scope.done();
                    return [2 /*return*/];
            }
        });
    }); });
    test("get current weather by city name", function () { return __awaiter(_this, void 0, void 0, function () {
        var city, countryCode, scope, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    scope = nock_1.default(environment_1.default.openweathermap.url)
                        ...
                        .reply(200, current_weather_mock_1.CURRENT_WEATHER_MOCK);
                    return [4 /*yield*/, weatherService.getCurrentWeatherByCity(city)];
                case 1:
                    response = _a.sent();
                    expect(response.data).toEqual(current_weather_mock_1.CURRENT_WEATHER_MOCK);
                    scope.done();
